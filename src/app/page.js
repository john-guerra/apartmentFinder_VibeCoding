      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-blue-800">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center text-white">
            <h1 className="text-5xl font-bold mb-6">Find Your Perfect Apartment</h1>
            <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
              Discover amazing apartments for rent. Browse listings, view photos, and find your next
              home with ease.
            </p>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose ApartmentFinder?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Find apartments that match your criteria with our intuitive search and filtering
                system.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                List your properties easily and connect with qualified tenants looking for their
                next home.
              </p>
            </div>
          </div>
        ...
        <div className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">Check out some of the latest apartment listings</p>
            </div>
              ...
              {recentListings.map((listing) => (
                ...
                >
                  <div className="relative h-48 bg-gray-200">
                    ...
                    <div
                      className={`absolute inset-0 bg-gray-300 items-center justify-center ${listing.photos && listing.photos.length > 0 ? "hidden" : "flex"}`}
                    >
                      <svg
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of renters and landlords who trust ApartmentFinder to connect them with
            perfect matches.
          </p>
          <Link
            href="/listings"
